-- Migration: 20260625500000_add_fornecedor_verificado.sql
-- Description: Adds a verificado column to the fornecedores table to support verified badges.

ALTER TABLE fornecedores
ADD COLUMN IF NOT EXISTS verificado BOOLEAN NOT NULL DEFAULT FALSE;

-- Update the RPC to include the new verificado column
DROP FUNCTION IF EXISTS get_active_suppliers_with_prices(text, text);
