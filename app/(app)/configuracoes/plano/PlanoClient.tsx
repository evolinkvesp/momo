      ...
      {isPremium ? (
        <div className="space-y-6 animate-fade-in">
          ...
          <a 
            ...
            className="w-full flex items-center justify-center gap-2 bg-white text-slate-900 border border-slate-200 py-4 rounded-full font-bold shadow-sm active:scale-[0.98] transition-all"
          >
        ...
        <div className="space-y-6 animate-fade-in">
          <div className="bg-white rounded-[24px] p-6 shadow-premium border border-slate-50 text-center relative overflow-hidden">
            <div className="w-16 h-16 bg-slate-50 rounded-full flex items-center justify-center mx-auto mb-4 text-slate-400">
              <Lock size={28} />
            </div>
            <h2 className="text-xl font-bold text-slate-900 mb-2">Plano Gratuito</h2>
            <p className="text-sm text-slate-500 mb-6 px-4">
              Você está no plano básico. Faça o upgrade para desbloquear todas as funcionalidades do Momo.
            </p>

            <div className="text-left space-y-3 mb-8 bg-slate-50 rounded-[20px] p-5">
              <h3 className="text-xs font-bold text-slate-400 uppercase tracking-widest mb-4">O que inclui no Premium:</h3>
              {[
