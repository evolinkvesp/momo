...
interface ActivityItem { tipo: string; titulo: string; subtitulo: string; data: string }
  ...
  const cards = [
    {
      ...
      sub: `+${metrics.newUsersWeek} esta semana`,
      icon: Users,
      color: "#4ade80",
    ...
    },
    {
      ...
      sub: `${metrics.premiumCount} assinantes`,
      icon: DollarSign,
      color: "#60a5fa",
      bg: "rgba(96,165,250,0.1)",
    },
    {
      label: "Fornec. pendentes",
      value: metrics.pendingSuppliers.toString(),
      sub: "Aguardando aprovação",
      icon: Building2,
      color: metrics.pendingSuppliers > 0 ? "#ef4444" : "#4ade80",
      bg: metrics.pendingSuppliers > 0 ? "rgba(239,68,68,0.1)" : "rgba(74,222,128,0.1)",
    },
    {
      label: "Pedidos hoje",
      value: metrics.todayOrders.toLocaleString("pt-BR"),
      sub: "Nas últimas 24h",
      icon: ShoppingBag,
      color: "#fbbf24",
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        {cards.map((card, i) => (
          ...
          >
            ...
            <p className="text-[10px] font-bold text-[rgba(255,255,255,0.28)] uppercase tracking-wide">
              {card.label}
            </p>
            <p className="text-[22px] font-black text-white tracking-tight mt-0.5 leading-none">
              {card.value}
            </p>
      ...
      <div className="grid md:grid-cols-2 gap-4">
        ...
        >
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="flex items-center gap-1 text-[#4ade80] text-[11px] font-bold">
              <TrendingUp size={13} /> Novos cadastros
            </div>
          </div>
        ...
        >
          <div className="flex items-center justify-between mb-4">
            ...
            <ArrowUpRight size={16} className="text-[#60a5fa]" />
          </div>
          <div className="h-[130px]">
            <ResponsiveContainer width="100%" height="100%">
              ...
              return (
                <div key={i} className="flex items-center gap-3 py-3">
                  ...
                  <div className="text-right shrink-0">
                    ...
                    <p className="text-[10px] text-[rgba(255,255,255,0.25)] mt-0.5">{formatDate(item.data)}</p>
                  </div>
                </div>
              );
            })}
